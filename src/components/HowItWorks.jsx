  ...
  return (
    <div className="relative">
      ...
      <div className="container custom_container mx-auto sm:px-3 px-6 mt-[104px] pb-[57px]">
        ...
        <div className="flex flex-row flex-wrap justify-center lg:justify-end items-center relative mt-[70px] lg:mt-[100px]">
          <img
            src={worksimg}
            alt="worksimg"
          ...
          <div className="lg:w-[50%] w-full lg:hidden flex justify-center">
              <img
                src={worksimg}
                alt="worksimg"
                className="w-full max-w-[401px] sm:max-w-[510px]"
              />
            </div>
