...
const Header = () => {
  ...
  return (
    <div id="home" className="bg-headerBg lg:bg-bgsize bg-cover bg-no-repeat ">
      <Navbar />
      <div className="container custom_container mx-auto sm:px-3 px-6 mt-[56px] pb-[30px] lg:mt-[63.86px]">
        <div className="flex flex-row flex-wrap items-center justify-center lg:justify-between">
          <div
            ...
            data-aos="fade-right"
          >
            <h1 className="text-white mx-auto text-xxs sm:text-6xl xl:text-md sm:!leading-xs leading-xxs font-light max-sm:max-w-[326px] xl:max-w-[520px] sm:mb-2 mb-3 lg:text-start text-center">
              <span className="font-extrabold">Find the location</span> of any
              phone by its number
            </h1>
            <p className="font-normal text-white text-sm sm:text-base leading-normal lg:max-w-[506px] mb-[32px] lg:mb-[24px] lg:text-start text-center md:px-14 lg:px-0 px-6">
              ...
              <div className="sm:max-w-[448px] max-w-[327px] w-full bg-white rounded-[4px] pl-[10px] flex items-center justify-between">
                ...
                <div>
                  <button
                    ...
                    className="relative flex items-center gap-1 bg-blue text-white text-sm sm:text-base font-semibold leading-lg rounded-[4px] py-[15.5px] px-[24px] transition-transform ease-linear duration-300 hover:scale-95"
                  >
