        ...
        <div className='mt-[97px] lg:mt-[132px] lg:mb-[33px] relative'>
            ...
            <div id='features' className="container sm:px-3 px-6 custom_container mx-auto" >
                <div className="flex justify-center items-center flex-col">
                    ...
                    <p className="text-grey text-sm sm:text-base font-normal !leading-normal md:max-w-[472px] text-center" data-aos="fade-up">
                ...
                <div className="flex justify-between max-lg:flex-wrap items-center mt-[31px] md:mt-[56px]">
                    <div className="lg:w-[34%] max-lg:order-1 max-lg:mt-12  w-full" data-aos="fade-right">
                        <div className=" max-w-[500px] lg:max-w-[376px] lg:h-[156px] h-[152px] rounded flex mx-auto relative overflow-hidden z-[1] after:absolute after:inset-0 after:bg-bluegradient after:opacity-0 after:transition-all after:ease-linear after:duration-300 hover:after:opacity-100 after:z-[-1] border border-gray-low-300 lg:p-[12px_18px_12px_0] p-[16px_16px_16px_0] group mb-[24px]">
                            <div className="flex gap-[14px] items-center">
                                <div className="bg-offBlue max-w-[61px] h-[57px] flex justify-center items-center sm:max-w-[75px] sm:h-[70px] group-hover:bg-white md:p-[17px_19px_17px_20px] p-[14px_16px] transition-all duration-300 ease-linear">
                                    <div>
                                        <CellPhone />
                                    </div>
                                </div>
                    ...
                    <div className="lg:w-[33%] w-full" data-aos="fade-up">
                        <img
                            src={anyoneMobile}
                            alt="anyoneMobile"
                    ...
                    <div className="lg:w-[34%] w-full max-lg:mt-[18px] max-lg:order-2 " data-aos="fade-right">
                        <div className="max-w-[500px] lg:max-w-[376px] lg:h-[156px] h-[152px] rounded flex mx-auto relative overflow-hidden z-[1] after:absolute after:inset-0 after:bg-bluegradient after:opacity-0 after:transition-all after:ease-linear after:duration-300 hover:after:opacity-100 after:z-[-1] border border-gray-low-300 lg:p-[12px_18px_12px_0] p-[16px_16px_16px_0] group mb-[24px]">
                            <div className="flex gap-[14px] items-center">
                                <div className="bg-offBlue max-w-[61px] h-[57px] sm:max-w-[75px] sm:h-[70px] flex justify-center items-center group-hover:bg-white md:p-[17px_19px_17px_20px] p-[14px_16px] transition-all duration-300 ease-linear">
                                    <div>
