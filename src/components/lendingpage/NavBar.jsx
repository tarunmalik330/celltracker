        ...
        <nav>
            <div className="container custom_container px-6 sm:px-3 mx-auto py-[20.72px]">
                <div className="flex justify-between items-center">
                    ...
                    <ul
                        className={`flex items-center gap-[35px] duration-300 max-lg:fixed max-lg:w-full max-lg:h-full max-lg:justify-start max-lg:pt-[121px] max-lg:flex-col max-lg:z-[3] max-lg:top-0 max-lg:left-[-105%] max-lg:p-[30px] max-lg:bg-white lg:pe-[40px]  xl:pe-[80px] ${nav && "!left-0"
                            }`}
                    >
