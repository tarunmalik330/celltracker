...
const UniversalPrivacy = () => {
    return (
        <div className='relative mt-[52px] md:mt-[76px]'>
            ...
            <div className='container xl:max-w-[1162px] mx-auto px-3'>
                <div className='flex justify-center items-center flex-col'>
                    <h2 className='font-light text-blue text-2lg sm:text-xsm md:text-6xl !leading-xxs text-center mb-[12px] lg:mb-2' data-aos="fade-up">Universal <span className='font-extrabold'>Privacy</span></h2>
