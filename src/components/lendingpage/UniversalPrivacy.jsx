  ...
  return (
    <div className="relative mt-[42px] xl:mt-[76px] sm:mt-9">
      <img
        ...
        src={vectorImg2}
        alt="vectorimg"
        className="right-0 top-[-6%] md:top-[-5%] lg:top-[-30%] xl:top-[10%] max-w-[41px] sm:max-w-[55px] md:max-w-[65px] lg:max-w-[106px] w-full absolute pointer-events-none"
      />
      <div className="container xl:max-w-[1162px] mx-auto px-3">
        <div className="flex justify-center items-center flex-col">
          <h2
            className="font-light text-blue text-2lg sm:text-xsm md:text-5xl !leading-xs text-center mb-[12px] lg:mb-2"
            data-aos="fade-up"
          >
        ...
        <div className="flex flex-row flex-wrap items-center justify-between mt-[34px] md:mt-[56px]">
          {privacyData.map((data, index) => (
            <div
              key={index}
              className="lg:w-[24%] sm:w-[48%] w-full mb-[18px] lg:mb-0"
              data-aos="zoom-in"
            >
